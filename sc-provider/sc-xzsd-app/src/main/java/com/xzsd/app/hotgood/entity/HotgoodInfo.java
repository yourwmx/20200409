package com.xzsd.app.hotgood.entity;
...
public class HotgoodInfo {
     ...
     * 排序
     */
    private String hotgoodsSort;
    /**
     * 展示数量
     */
    private String hotgoodShowNumber;
    /**
     * 图片
     */
    ...
    public String getHotgoodsSort() {
        return hotgoodsSort;
    }

    public void setHotgoodsSort(String hotgoodsSort) {
    ...
    public String getHotgoodShowNumber() {
        return hotgoodShowNumber;
    }

    public void setHotgoodShowNumber(String hotgoodShowNumber) {
        this.hotgoodShowNumber = hotgoodShowNumber;
    }

    public String getGoodsFixMoney() {
        return goodsFixMoney;
    }

    public void setGoodsFixMoney(String goodsFixMoney) {
